...
RED.i18n = (function() {
    ...
    return {
        init: function(options, done) {
            ...
            var locale = (locale ? locale[0] : null); //Added by Homegear GmbH. locale has to be defined here as the "(... ? ... : ...)" statement doesn't seem to work in opts when locale is undefined.
            var opts = {
                lng: locale, //Added by Homegear GmbH: Get locale from locale array defined in index.php
