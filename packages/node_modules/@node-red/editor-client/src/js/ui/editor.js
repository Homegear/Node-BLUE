...
RED.editor = (function() {
    ...
    function refreshLabelForm(container,node) {
        ...
        if (formInputs === undefined) {
            ...
            //inputCount = Math.min(1,Math.max(0,parseInt(formInputs))); //Removed by Homegear GmbH
            inputCount = Math.max(0,parseInt(formInputs)); //Added by Homegear GmbH to support multiple inputs
            if (isNaN(inputCount)) {
                inputCount = 0;
            }
        }
