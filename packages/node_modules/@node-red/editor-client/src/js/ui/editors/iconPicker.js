 ...
 *
 * Changes:
 * - Added support for Homegear UI icons.
 **/
            ...
            Object.keys(iconSets).forEach(function(moduleName) {
                ...
                if (icons.length > 0) {
                    ...
                    icons.forEach(function(icon) {
                        ...
                        if (moduleName == "homegear-ui-icons") { //Added by Homegear GmbH
                            icon_url = RED.nodes.homegearUiIcons.getIconUrl(icon); //Added by Homegear GmbH
                            iconDiv.data('icon', icon); //Added by Homegear GmbH
                        } else { //Added by Homegear GmbH
