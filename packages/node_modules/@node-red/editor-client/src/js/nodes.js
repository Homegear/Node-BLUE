            ...
            if (n.wires) {
                for (var w1=0;w1<n.wires.length;w1++) {
                    ...
                    for (var w2=0;w2<wires.length;w2++) {
                        ...
                        // Added by Homegear GmbH - copied from above to enable importing of Node-RED flows
                        } else if (node_map.hasOwnProperty(wires[w2])) {
                            if (n.z === node_map[wires[w2]].z) {
                                var link = {source:n,sourcePort:w1,target:node_map[wires[w2]],targetPort:0}; //Added by Homegear GmbH to support multiple inputs
                                addLink(link);
                                new_links.push(link);
                            } else {
                                console.log("Warning: dropping link that crosses tabs:",n.id,"->",node_map[wires[w2]].id);
