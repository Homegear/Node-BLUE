...
var RED = (function() {
            ...
            if (topic == "notification/node/added") {
                RED.settings.refreshSettings(function(err, data) {
                    ...
                    msg.forEach(function(m) {
                        ...
                        RED.i18n.loadNodeCatalog(function() { //Added by Homegear GmbH - it is not possible at the moment to load the translations of a single module
                            var lang = localStorage.getItem("editor-language")||RED.i18n.detectLanguage();
                            $.ajax({
                                headers: {
                                    "Accept":"text/html",
    ...
    function loadEditor() {
        ...
        //loadPluginList(); //Commented by Homegear GmbH
    }
