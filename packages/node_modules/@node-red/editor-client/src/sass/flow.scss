...
.red-ui-flow-node-port-input-label {
    stroke-width: 0;
    fill: #888;
    font-size: 11px;
...
.red-ui-flow-node-port-output-label {
    stroke-width: 0;
    fill: #888;
    font-size: 11px;
    alignment-baseline: middle;
...
.red-ui-flow-node-fixed-input {
    fill: $node-status-fixed-input-background;
    stroke: $node-status-fixed-input-border;
    cursor: default;
    stroke-width:1px;
    stroke-linejoin: round;
    stroke-linecap: round;
...
.red-ui-flow-node-working,
.red-ui-flow-node-working .red-ui-flow-node {
    stroke-width: 2;
    stroke: $node-working-color !important;
}
...
.red-ui-flow-node-status-label-top {
    @include disable-selection;
    stroke-width: 0;
    fill: #888;
    font-size:8pt;
...
g.red-ui-flow-link-working path.red-ui-flow-link-line {
    stroke: $node-working-color !important;
}
