 ...
 *
 * Changes:
 * - Changed colors to Node-BLUE and added Node-BLUE-specific classes.
 *
 * Todo after update:
 **/
...
$workspace-button-background-primary: #3fa9f5;
$workspace-button-background-primary-hover: #2f99e5;
...
$node-status-fixed-input-border: rgb(100, 60, 0);
$node-status-fixed-input-background: rgb(255, 155, 0);
...
$deploy-button-background: #3FA9F5;
$deploy-button-background-hover: #2F99E5;
$deploy-button-background-active: #3FA9F5;
...
$tourGuide-border: #3fa9f5;
$tourGuide-heading-color: #3fa9f5;
